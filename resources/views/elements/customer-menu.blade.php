        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="dashboard_menu">
                    ...
                    <li class="{{NULL !==strtolower($data['breadcrub']) && strtolower($data['breadcrub'])=='favourite'?'active':''}}"><a href="{{url(app()->getLocale().'/market/temp/myfavorite')}}"><span class="lnr lnr-cart"></span>@lang('profile.favourite')</a></li>
