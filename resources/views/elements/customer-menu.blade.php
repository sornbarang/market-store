        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="dashboard_menu">
                    <li class="{{NULL !==strtolower($data['breadcrub']) && strtolower($data['breadcrub'])=='profile'?'active':''}}"><a href="{{route('market.myprofile')}}"><span class="lnr lnr-user"></span>@lang('profile.profile')</a></li>
