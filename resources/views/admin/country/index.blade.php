            ...
            <div class="col-xs-12">
                <div class="card card-data-tables product-table-wrapper">
                    <header class="card-heading">
                        ...
                        <h2 class="card-title">List Countries</h2>
                            ...
                            <table id="productsTable" class="mdl-data-table product-table m-t-30" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <th data-orderable="false" class="col-xs-2">
                                        <button id="add-new-country" class="btn btn-primary btn-fab  animate-fab"><i class="zmdi zmdi-plus"></i></button>
                                    </th>
                                </tr>
                                </thead>
                                <tbody>
                                @foreach($counties as $county)
                                    <tr>
                                        <td class="checkbox-cell">
                                            <span class="checkbox">
                                              <label>
                                                <input type="checkbox" value="{{$county->id}}" id="">
                                                <span class="checkbox-material"></span>
                                              </label>
                                            </span>
                                        </td>
                                        ...
                                        <td>{{$county->slug}}</td>
                                        <td>
                                            <a href="{{action('Admin\CountryController@edit',['id' => $county->id])}}" class="btn btn-info btn-fab btn-fab-sm"><i class="zmdi zmdi-edit"></i></a>
                                            <a href="javascript:void(0)" class="btn btn-danger btn-fab btn-fab-sm warning-delete" data-id="{{$county->id}}"><i class="zmdi zmdi-delete"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
...
@section('javascript')
    <script>
        ...
        $(document).on('click touch', '#add-new-country', function(e) {
            window.location.href='{{action('Admin\CountryController@create')}}'
        });
