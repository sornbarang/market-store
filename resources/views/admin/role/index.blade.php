                            ...
                            <table id="productsTable" class="mdl-data-table product-table m-t-30" cellspacing="0" width="100%">
                                ...
                                <span class="checkbox">
                                  <label>
                                    ...
                                    <td>Read,Write</td>
                                    <td>
                                        <a href="{{action('Admin\RoleController@edit',['id' => '1'])}}" class="btn btn-info btn-fab btn-fab-sm"><i class="zmdi zmdi-edit"></i></a>
                                        <a href="{{action('Admin\RoleController@destroy',['id' => '1'])}}" class="btn btn-danger btn-fab btn-fab-sm"><i class="zmdi zmdi-delete"></i></a>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
