                ...
                <div class="col-md-12">
                    <div class="breadcrumb">
                        <ul>
                            ...
                            <li><a href="dashboard.html">Manage Item</a></li>
                            <li class="active"><a href="#">Edit Item</a></li>
                        </ul>
                    </div>
                    <h1 class="page-title">Edit MartPlace Extension Bundle</h1>
                </div><!-- end /.col-md-12 -->
            </div><!-- end /.row -->
        </div><!-- end /.container -->
    </section>
                        ...
                        <form action="#">
                            <div class="upload_modules">
                                <a class="toggle_title" href="#collapse2" role="button" data-toggle="collapse" aria-expanded="false" aria-controls="collapse2">
                                    <h4>Item Name & Description <span class="lnr lnr-chevron-down"></span></h4>
                                </a>
                                ...
                                <div class="information__set toggle_module collapse in" id="collapse2">
                                    <div class="modules__content">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="product_name" class="text_field" value="Rida - vCard Portfolio/Resume Template">
                                        </div>
                            ...
                            <div class="upload_modules module--upload">
                                <a class="toggle_title" href="#collapse3" role="button" data-toggle="collapse" aria-expanded="false" aria-controls="collapse3">
                                    <h4>Update Files <span class="lnr lnr-chevron-down"></span></h4>
                                </a>
                            ...
                            <div class="upload_modules">
                                <a class="toggle_title" href="#collapse4" role="button" data-toggle="collapse" aria-expanded="false" aria-controls="collapse4">
                                    <h4>Other Information <span class="lnr lnr-chevron-down"></span></h4>
                                </a>
                                ...
                                <div class="information__set toggle_module collapse" id="collapse4">
                                    <div class="modules__content">
                                                ...
                                                <div class="form-group">
                                                    <label for="selected">Files Included</label>
                                                        <select name="country" id="selected" multiple class="text_field">
                                                            ...
                                                            <option value="psd" selected>psd</option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="dimension" class="text_field" value="1920x6000">
                                                </div>
                                            </div><!-- end /.col-md-6 -->
                                        </div><!-- end /.row -->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="select-wrap select-wrap2">
                                                <select name="version" id="soft" class="text_field">
                                                    ...
                                                    <option value="4" selected>WordPress 4</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="tags" id="tags" class="text_field">creative portfolio, cv, html5, material, minimal portfolio, one page, online card, online cv, personal portfolio, portfolio</textarea>
                                        </div>
                                    </div><!-- end /.upload_modules -->
                                </div>
                            </div><!-- end /.upload_modules -->
                            ...
                            <div class="upload_modules">
                                <a class="toggle_title" href="#collapse5" role="button" data-toggle="collapse" aria-expanded="false" aria-controls="collapse5">
                                    <h4>Update Pricing <span class="lnr lnr-chevron-down"></span></h4>
                                </a>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" id="rlicense" class="text_field" value="17.00">
                                                    </div>
                                                </div>
                                            </div><!-- end /.col-md-6 -->
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-addon">$</span>
                                                        <input type="text" id="exlicense" class="text_field" placeholder="500.00">
                                                    </div>
                                                </div>
                                            </div><!-- end /.col-md-6 -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-addon">$</span>
                                                        <input type="text" id="single_use" class="text_field" value="17.00">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-addon">$</span>
                                                        <input type="text" id="double_use" class="text_field" value="30.00">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-addon">$</span>
                                                        <input type="text" id="multi_user" class="text_field" value="5000000000.00">
                                                    </div>
                                                </div>
                                            </div>
                                        </div><!-- end /.row -->
