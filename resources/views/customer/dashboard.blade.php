                            ...
                            <div class="dashboard__content">
                                <table class="table table-responsive">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="country_flag"><img src="{{asset('/')}}images/flam.jpg" alt="Country Flag"></div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="country_flag"><img src="{{asset('/')}}images/flg2.png" alt="Country Flag"></div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="country_flag"><img src="{{asset('/')}}images/flg3.png" alt="Country Flag"></div>
                                                <span>Canada</span>
                                            </td>
                                            <td>170</td>
                                            <td>$65</td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="country_flag"><img src="{{asset('/')}}images/flg4.png" alt="Country Flag"></div>
                                                <span>Newzland</span>
                                            </td>
                                            <td>78</td>
                                            <td>$24</td>
                                ...
                                <ul>
                                        ...
                                        <div class="single_sell">
                                            <div class="single_sell__thumb-title">
                                                <div class="prod_thumbnail">
                                                    <img src="{{asset('/')}}images/prodthumb.png" alt="product thumbnail">
                                                </div>
                                                <div class="prod_title">
                                                    <h4>Finance and Consulting Business Theme</h4>
                                                    <div class="category">
                                                        <img src="{{asset('/')}}images/catword.png" alt="category">
                                                        <span>Wordpress</span>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <li>
                                        <div class="single_sell">
                                            <div class="single_sell__thumb-title">
                                                <div class="prod_thumbnail">
                                                    <img src="{{asset('/')}}images/prodthumb2.jpg" alt="product thumbnail">
                                                </div>
                                                <div class="prod_title">
                                    ...
                                    <li>
                                        <div class="single_sell">
                                            <div class="single_sell__thumb-title">
                                                <div class="prod_thumbnail">
                                                    <img src="{{asset('/')}}images/prodthumb3.jpg" alt="product thumbnail">
                                                </div>
                                                <div class="prod_title">
                                ...
                                <ul>
                                    <li>
                                        <div class="single_buyer">
                                            <div class="buyer__thumb_title">
                                                <div class="thumb">
                                                    <img src="{{asset('/')}}images/buyr1.jpg" alt="Buyer Images">
                                                </div>
                                                <div class="title">
                                    ...
                                    <li>
                                        <div class="single_buyer">
                                            <div class="buyer__thumb_title">
                                                <div class="thumb">
                                                    <img src="{{asset('/')}}images/buyr2.png" alt="Buyer Images">
                                                </div>
                                                <div class="title">
                                    ...
                                    <li>
                                        <div class="single_buyer">
                                            <div class="buyer__thumb_title">
                                                <div class="thumb">
                                                    <img src="{{asset('/')}}images/buyr3.jpg" alt="Buyer Images">
                                                </div>
                                                <div class="title">
                                                    <h4>Shah Hossain</h4>
                                                    <p>Biplobland</p>
