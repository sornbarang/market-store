...
class CustomerController extends Controller
{
    ...
    {   
        ...
        if ($validator->fails()) {
            return redirect('shop/mysetting')
        ...
        if($user){  
            ...
            $user->save();  
            if($user){
                return redirect('shop/mysetting')->with('success', 'Record has been update!'); 
            }
            return redirect('shop/mysetting')->with('error', 'Problem with update profile!');
        }
        return redirect('shop/mysetting')->with('error', 'Problem with update profile!');
    }
    ...
    public function myDeletePro(ProductTranslate $slug){
        ...
        if($product){
            ...
            $product->delete();
            return redirect('shop/mymanageitem')->with('success', 'Record has been deleted');
        }
        return redirect('shop/mymanageitem')->with('error', 'Problem with delete record!');
    }
    /**
     * User's profile
     *
    ...
    { 
        ...
        if($request->isMethod('post')){
            ...
            if ($validator->fails()) {
                return redirect('shop/myitemupload')
                    ->withErrors($validator)
                    ->withInput();
            } 
            $name = $request->name;
            ...
            $product = Product::create([
                ...
                if($product){ 
                    ...
                    return redirect('shop/myitemupload')->with('success', 'Record has been added!');
                }
                return redirect('shop/myitemupload')->with('error', '<strong>Oh snap!</strong> Change a few things up and try submitting again!');
        }
        $data['type']='shop';
    ...
    {  
        ...
        if($request->isMethod('post')){
            ...
            if ($validator->fails()) {
                return redirect()->route('shop.edititem',$slug)
                    ->withErrors($validator)
                    ->withInput();
            } 
            ...
            if($request->hasFile('photos3')){
                ...
                return redirect('shop/mymanageitem')->with('success', 'Record has been updated!');
            }
        }
